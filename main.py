...
# import Line graphics
# store initial point of touch to the dictionary
# add all the points to the dictionary as we drag along
# make that trajectory appear on the widget
# make it of random color
